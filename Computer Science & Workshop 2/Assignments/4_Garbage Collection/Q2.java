...
public class Q2 {    
    public static void main(String[] args) {
        ...
        System.out.println("An object is eligible for garbage collection when there are no references to it.");
        System.out.println("The garbage collector automatically deletes these objects and reclaims the memory.");
